...
public interface OrderService {
	...
	Order_master selectOne_master(OrderSession order, int order_no); //주문번호의 주문마스터
	List<Order_detail> selectList_detail(OrderSession order, int order_no); //주문번호 하나의 detail 리스트 ( 예, 주문번호 2번의 피자디테일..)
